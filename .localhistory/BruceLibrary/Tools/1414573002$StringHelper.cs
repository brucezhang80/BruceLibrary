...
namespace BruceLibrary.Tools
{
    public class StringHelper
    {
        ...
        /// <returns></returns>
        public List<string> GetStrArray(string str, char speater, bool toLower)
        {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public string GetArrayStr(List<int> list)
        {
            StringBuilder sb = new StringBuilder();
            for (int i = 0; i < list.Count; i++)
            {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public string GetArrayValueStr(Dictionary<int, int> list)
        {
            StringBuilder sb = new StringBuilder();
        ...
        /// <returns></returns>
        public List<string> GetSubStringList(string o_str, char sepeater)
        {
            List<string> list = new List<string>();
        ...
        /// <returns></returns>
        public string GetCleanStyle(string StrList, string SplitString)
        {
            string RetrunValue = "";
            //如果为空，返回空值
            if (StrList == null)
        ...
        /// <returns></returns>
        public string GetNewStyle(string StrList, string NewStyle, string SplitString, out string Error)
        {
            string ReturnValue = "";
            //如果输入空值，返回空，并给出错误提示
            if (StrList == null)
        ...
        /// <returns></returns>
        public string[] SplitMulti(string str, string splitstr)
        {
        ...
        public string SqlSafeString(string String, bool IsDel)
        {
            if (IsDel)
            {
        ...
        public int StrToId(string _value)
        {
