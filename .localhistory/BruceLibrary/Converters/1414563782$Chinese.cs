...
namespace BruceLibrary.Converters
{
    public class Chinese
    {
        ...
        #region Init
        public static Chinese Current = new Chinese();
        private Chinese()
        {
        }
        #endregion
        ...
        public string Chinese2Pinyin(string strChinese)
        {
        ...
        /// <returns>首字母</returns>
        public string GetCodstring(string strChinese)
        {
            int i = 0;
            ushort key = 0;
            ...
            byte[] unicodeBytes = unicode.GetBytes(strChinese);
