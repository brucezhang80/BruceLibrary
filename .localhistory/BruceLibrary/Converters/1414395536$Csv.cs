...
namespace BruceLibrary.Converters
{
    public class Csv
    {
        ...
        public bool DataTable2Csv(DataTable dataTable, string strFilePath, string tableheader, string columname)
        {
            try
            {
        ...
        public DataTable Csv2DataTable(string filePath, int intTitleRowNumber, DataTable dataTable)
        {
